    ...
    <div className="footer mt-5">
      <div className="row">
        <div className="col-12 col-lg d-flex flex-column justify-content-between p-0 m-0">
          <div className="card border-0 bg-transparent">
            <div className="card-body">
              <h5 className="card-title text-white">Nuestra tienda</h5>
              <ul className="list-unstyled">
                <li>
                  <a href="#nothing">Sobre nosotros</a>
                </li>
                <li>
                  <a href="#nothing">Reseñas</a>
                </li>
                <li>
                  <a href="#nothing">Comunicaciones</a>
                </li>
                <li>
                  <a href="#nothing">Trabaja con nosotros</a>
                </li>
                <li>
                  <a href="#nothing">Canales oficiales</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="col-12 col-lg d-flex flex-column justify-content-between p-0 m-0">
          <div className="card border-0 bg-transparent">
            <div className="card-body">
              <h5 className="card-title text-white">Ayuda</h5>
              <ul className="list-unstyled">
                <li>
                  <a href="#nothing">Pagos</a>
                </li>

                <li>
                  <a href="#nothing">Envio</a>
                </li>
                <li>
                  <a href="#nothing">Cancelacion y devolucion</a>
                </li>
                <li>
                  <a href="#nothing">Preguntas</a>
                </li>
                <li>
                  <a href="#nothing">Seguir orden</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="col-12 col-lg p-0 m-0">
          <div className="card border-0 bg-transparent">
            <div className="card-body">
              <h5 className="card-title text-white">Contactanos</h5>
              <ul className="list-unstyled">
                <li>
                  <a href="#nothing">X</a>
                </li>
          ...
          <div className="desktop-section">
            <div className="desktop-original">
              ...
              <div className="promise">
                <strong data-reactid="108">100% ORIGINAL </strong>
                <br /> Productos de alta calidad{" "}
              </div>
            </div>
          </div>
          <div className="desktop-section">
            ...
            <div className="promise">
              <strong>Devoluciones en 30 Dias </strong>
              <br />
              Con tu orden de pago
            </div>
          </div>
        </div>
        ...
        <div className="foot_">
          <div className="foot__">
            ...
            <img
              ...
              alt="img"
            />
            <span>Compra de digitalmente</span>
          </div>
          <div className="foot__">
            <img
